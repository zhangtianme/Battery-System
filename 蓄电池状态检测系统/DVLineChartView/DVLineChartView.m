...
//    self.xAxisView.chartViewFill = self.isChartViewFill;
    if (isZoom) {
        self.xAxisView.showPointLabel = NO;
    }
    else
    {
        self.xAxisView.showPointLabel = YES;
    }
//    self.xAxisView.showPointLabel = self.isShowPointLabel;
    ...
    NSLog(@"self.xAxisView---%@",NSStringFromCGRect(self.xAxisView.frame));
     NSLog(@"self.yAxisView---%@",NSStringFromCGRect(self.yAxisView.frame));
//    if (self.index < 0) {
//        
