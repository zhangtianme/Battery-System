...
//    tagInputField_.placeholder = @"tag";
    ...
    tagInputField_.userInteractionEnabled = NO;
...
{
    for (UIView *view in tagSubviews_) {
        view.backgroundColor = [UIColor colorWithRed:0.9
                                               green:0.91
                                                blue:0.925
                                               alpha:1];
    }
    UIView *view = tagSubviews_[index];
    view.backgroundColor = [UIColor colorWithRed:0X50/255.0 green:0XE3/255.0 blue:0XC2/255.0 alpha:1.0];
}
@end
